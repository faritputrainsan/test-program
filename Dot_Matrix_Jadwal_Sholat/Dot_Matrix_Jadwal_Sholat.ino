...
char text[Text_Size] = "AAAAAAAAAAAAAAAAAAAAAAAAAAAA";
...
//  ~0x36, ~0x49, ~0x49, ~0x49, ~0x7F, ~0x00,
//  ~0x22, ~0x41, ~0x41, ~0x41, ~0x3E, ~0x00,
...
ISR(TIMER2_OVF_vect)
{
  ...
  */
  ...
  if (disp_mode == Text_Only)
  {
    ...
    for (col = DISP_COL_CNT; col > 0 ; col--)
    {
